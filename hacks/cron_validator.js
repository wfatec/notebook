 ...
 */
export const cronValidate = (cronExpression ) => {
    //alert("校验函数的开始！");
...
const checkSecondsField = (secondsField) => {
    return checkField(secondsField, 0, 59);
}


const checkField = (secondsField, minimal, maximal) => {
...
const checkIntValue = (value, minimal, maximal, checkExtremity) => {
    try {
...
const checkMinutesField = (minutesField) => {
    return checkField(minutesField, 0, 59);
}

const checkHoursField = (hoursField) => {
    return checkField(hoursField, 0, 23);
}

const checkDayOfMonthField = (dayOfMonthField) => {
    if (dayOfMonthField == "?") {
        return true;
    }
...
const checkMonthsField = (monthsField) => {
...
const checkDayOfWeekField = (dayOfWeekField) => {
...
const checkYearField = (yearField) => {
    return checkField(yearField, 1970, 2099);
}


const checkFieldWithLetter = (value, letter, minimalBefore, maximalBefore,
...
const checkIncrementField = (value, minimal, maximal) => {
